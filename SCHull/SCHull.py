...
import sys
sys.path.append('./alignment/pyorbit/utils/')
from alignment3D import *
from geometry import angle_between_vectors, project_onto_plane
...
class SCHull(metaclass=ABCMeta):
    ...
    def get_schull(self, data, cat_data=None, data_edge_index=None, *args, **kwargs):
        ...
        # PROJECT ONTO SPHERE
        ### modified by hyh ###
        shell_data, shell_data_ch, shell_data_proj_id_rcrd, _= self.project_sphere(data, 
                                                                                   cat_data, 
                                                                                   *args, 
                                                                                   **kwargs)
